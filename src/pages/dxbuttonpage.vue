<template>
  <div class="wrap-content">
    ...
    <div class="item-content">
      ...
      <dx-table :data="attrDatas" :borderRow="true" tableHeadClass="table-head">
    ...
    <div class="item-content">
      <div style="margin-bottom: 2rem">
        ...
        <p>
          点击button会，会触发一个click事件，用于执行回调——this.$emit('dx-button-click')
        </p>
      </div>
    </div>
  </div>
...
@Component
export default class DxButtonPage extends Vue {
  htmlString1 = "";
  htmlString2 = "";
  htmlString3 = "";
  htmlString4 = "";
